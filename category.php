	...
	<body id="category">
		<div id="container" class="popular-memes">
			...
			<table id="body-table">
								...
								if (time() - strtotime($date) <= 86400) {
									if( $count%2 == 0) {
										echo '<a href="meme.php?file='.$row['meme_path'].'">' .
											...
											'<div class="entry">' . 
											'<img src="http://memes.memefriend.com/sandbox/thumbnails/'.$fullmemepath.'" class="thumbnail" alt="Meme" width="156px" height="auto" />' . 
											"</div>" .
										...
										echo '<a href="meme.php?file='.$row['meme_path'].'">' .
											'<div class="image-container">' .
											'<div class="entry">' .
											'<img src="http://memefriend.com/sandbox/thumbnails/'.$fullmemepath.'" class="thumbnail" alt="Meme" width="156px" height="auto" />' . 
											"</div>" .
											'<img src="img/new-badge.png" alt="newbadge" width="74px" height="74px" />' . 
											"</div></a>";
									}
				...
				<tr>
					<td>
						<div class="paginator"><span class="pages"><?php echo "Page $pages->current_page of $pages->num_pages"?></span><br/><?php echo $pages->display_pages(); ?></div>
